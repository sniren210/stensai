        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5>Jadwal guru {{$guru->guru->nama}} </h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if (Auth::guard('web')->check())            
                    <td>
                      <a href="{{ url('/jadwal-guru/'.$data->id.'/edit') }}" class="badge badge-success">Edit</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Yakin ingin menghapus Jadwal Guru {{$data->guru->nama}}
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <form method="POST" action="/jadwal-guru/{{$data->id}}">
          @csrf
          @method('delete')
