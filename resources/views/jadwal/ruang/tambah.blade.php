      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/jadwal-ruang/">
              @csrf
              @method('post')
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="custom-select @error('ruang') is-invalid @enderror" name="ruang">
                    ...
                    <option value="{{$data->id}}">{{$data->nmr_ruang}} {{$data->jenis_ruang}}</option>
                    @endforeach
                  </select>
                  @error('ruang')
              ...
              <div class="card-footer">
                <a href="{{ url('/jadwal-ruang') }}" type="submit" class="btn btn-link">Kembali</a>
