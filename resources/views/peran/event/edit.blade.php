            ...
            <form method="POST" action="/event/{{$event->id}}" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama') is-invalid @enderror" id="exampleInputEmail1" name="nama" value="{{ $event->nama}} ">
                  @error('nama')
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control @error('deskripsi') is-invalid @enderror" rows="3" placeholder="Enter ..." name="deskripsi">{{ $event->deskripsi}}</textarea>
                  @error('deskripsi')
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
