...
<style>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$data->nip}} </td>
                    <td>
                      <img src="{{ asset('img/guru/'.$data->foto) }}" alt="{{$data->nama}} " width="100" height="100">
                    </td>
                    <td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          yakin Ingin menghapus Data guru {{$data->nama}}?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <form action="/buku-induk/guru/{{$data->id}}" method="POST">
            @csrf
            @method('delete')
  ...
  <div class="modal fade" id="export" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Export Data Guru</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-6">
              <p>Export Excel</p>
              <a href="{{ url('/buku-induk/export/guru') }}">Excel</a>
            </div>
            <div class="col-6">
              <p>Export PDF</p>
              <a href="{{ url('/buku-induk/pdf/guru') }}">PDF</a>
            </div>
          </div>
        </div>
        <div class="modal-footer">
  ...
  <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/buku-induk/import/guru" method="POST" enctype="multipart/form-data">
            @csrf
            @method('post')
            <div class="form-group">
              <label for="exampleInputFile">Import</label>
              <sub>Template Excel harus seperti <a href="{{ url('/import/Guru.xlsx') }}">Ini</a></sub>
