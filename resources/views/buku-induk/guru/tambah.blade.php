      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/buku-induk/guru" enctype="multipart/form-data">
              @csrf
              @method('post')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nip') is-invalid @enderror" id="exampleInputEmail1" name="nip" value="{{old('nip')}}">
                  @error('nip')
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('npwp') is-invalid @enderror" id="exampleInputEmail1" name="npwp" value="{{old('npwp')}}">
                  @error('npwp')
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
              ...
              <div class="card-footer">
                <a href="{{ url('/buku-induk/siswa/table') }}" class="btn btn-link">Kembali</a>
