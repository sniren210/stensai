        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">nilai siswa Create</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/buku-induk/nilai-siswa">
              @csrf
              @method('post')
              <div class="card-body">
              ...
              <div class="card-footer">
                <a href="{{ url('/buku-induk/nilai-siswa') }}" type="submit" class="btn btn-link">Kembali</a>
