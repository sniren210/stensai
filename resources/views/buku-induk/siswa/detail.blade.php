      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="{{ url('/buku-induk/siswa/nilai/'.$siswa->id) }}" class="btn btn-primary btn-block"><b>Lihat Nilai</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
          ...
          <div class="card-footer" style="background-color: unset">
            <a href="{{ url('/buku-induk/siswa/') }}" class="btn btn-primary">Kembali</a>
          </div>
          <!-- /.col -->
        </div>
        <!-- /.row -->
